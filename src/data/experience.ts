        ...
        description: [
           {
                ...
                desc: [
                    ...
                    "Designed and implemented a full psychometric evaluation module: form rendering, candidate response capture, and structured persistence — owning backend, frontend (Angular), and database layers entirely.",
        ...
        description: [
            ...
            },
            {
                ...
                desc: [
                    ...
                    "Gestioné pipelines CI/CD y monitoreo en producción end-to-end.",
                    "Referencia del cliente disponible a solicitud."
                ]
            }
        ],
        current: false
        ...
        description: [
            {
                ...
                desc: [
                    ...
                    "Diseñé e implementé módulo completo de evaluación psicométrica: formularios, captura de respuestas y persistencia estructurada con propiedad total de backend, frontend (Angular) y base de datos.",
